...
func (x *ValidateTokenRequest) GetTokenString() string {
	if x != nil {
...
type RefreshTokenRequest struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	RefreshTokenString string                 `protobuf:"bytes,1,opt,name=refresh_token_string,json=refreshTokenString,proto3" json:"refresh_token_string,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *RefreshTokenRequest) GetRefreshTokenString() string {
	if x != nil {
...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\"\x9b\x01\n" +
	...
	"\ftoken_string\x18\x01 \x01(\tR\vtokenString\"L\n" +
	...
	"\x14refresh_token_string\x18\x01 \x01(\tR\x12refreshTokenString\"^\n" +
	"\x14RefreshTokenResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken2\x8b\x02\n" +
	"\vAuthService\x129\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB\x0eZ\f./proto/authb\x06proto3"
