...
func (x *GetAllUserResponse) GetUsers() []*GetUserResponse {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *UpdateUserResponse) GetUser() *GetUserResponse {
	if x != nil {
		return x.User
	}
	return nil
...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\"\x13\n" +
	"\x11GetAllUserRequest\"A\n" +
	"\x12GetAllUserResponse\x12+\n" +
	"\x05users\x18\x01 \x03(\v2\x15.user.GetUserResponseR\x05users\" \n" +
	...
	"\n" +
	"first_name\x18\x05 \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\x06 \x01(\tR\blastName\"Y\n" +
	"\x12UpdateUserResponse\x12)\n" +
	"\x04user\x18\x01 \x01(\v2\x15.user.GetUserResponseR\x04user\x12\x18\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x0eZ\f./proto/userb\x06proto3"
...
var file_proto_user_user_proto_depIdxs = []int32{
	3, // 0: user.GetAllUserResponse.users:type_name -> user.GetUserResponse
	8, // 1: user.GetUserResponse.created_at:type_name -> google.protobuf.Timestamp
	8, // 2: user.GetUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	3, // 3: user.UpdateUserResponse.user:type_name -> user.GetUserResponse
	0, // 4: user.PostService.GetAllUser:input_type -> user.GetAllUserRequest
	2, // 5: user.PostService.GetUserByID:input_type -> user.GetUserRequest
	4, // 6: user.PostService.UpdateUser:input_type -> user.UpdateUserRequest
	6, // 7: user.PostService.DeleteUser:input_type -> user.DeleteUserRequest
	1, // 8: user.PostService.GetAllUser:output_type -> user.GetAllUserResponse
	3, // 9: user.PostService.GetUserByID:output_type -> user.GetUserResponse
	5, // 10: user.PostService.UpdateUser:output_type -> user.UpdateUserResponse
	7, // 11: user.PostService.DeleteUser:output_type -> user.DeleteUserResponse
